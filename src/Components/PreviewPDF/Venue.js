...
const Venue = (props) => {
  ...
  const venueTextColor = convert.rgb.hex(
    props.color.venueText.r,
    props.color.venueText.g,
    props.color.venueText.b
  );
  const venueBarColor = convert.rgb.hex(
    props.color.venueBar.r,
    props.color.venueBar.g,
    props.color.venueBar.b
  );
  const oddRowColor = convert.rgb.hex(
    props.color.oddRow.r,
    props.color.oddRow.g,
    props.color.oddRow.b
  );
  const evenRowColor = convert.rgb.hex(
    props.color.evenRow.r,
    props.color.evenRow.g,
    props.color.evenRow.b
  );
  const evenLine =
    props.grid["even"].width + 1 + "px " + props.grid["even"].type + " black";
  const oddLine =
    props.grid["odd"].width + 1 + "px " + props.grid["odd"].type + " black";
  ...
  const styles = StyleSheet.create({
    ...
    triangle: {
      ...
      width: "0",
      height: "0",
      borderLeft: "25px solid #" + venueBarColor,
